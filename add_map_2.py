...
# Try to find the end of the <div className="grid grid-cols-2 gap-4"> block
# The block ends after the Longitude input's closing div.
pattern = r'placeholder="80\.7718"[\s\S]*?/>\s*</div>\s*</div>\s*</div>'
# Wait, let's just find the closing tags after Longitude
pattern = r'(placeholder="80\.7718"[^>]*>\s*</div>\s*</div>)'
